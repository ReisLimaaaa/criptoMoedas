...
export function Detail(){
    ...
    useEffect(() =>{
        function getData(){
            fetch(`https://sujeitoprogramador.com/api-cripto/coin/?key=85054531554a1681&symbol=${cripto}`)
    ...
    if(loading){
        return(
            <div className={style.container}>
                <h4 className={style.center}>Loading...</h4>
            </div>
    ...
    return(
        <div className={style.container}>
            ...
            <section className={style.content}>
                ...
                <p>
                    <strong>Variação do Preço: </strong> <span className={Number(detail?.delta_24h) >= 0 ? style.profit : style.loss}> {detail?.delta_24h}</span>
                </p>
